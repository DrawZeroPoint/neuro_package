...
static const string JOINTNAME_PRE = "right_arm_joint";
...
{
    ros::init(argc,argv,"right_arm_trajectory_controller");
    ros::NodeHandle n;
    uint loop_counter = 0;
    ...
    ros::Subscriber my_sub=n.subscribe("/right_arm_controller/follow_joint_trajectory/goal",1000,Callback);
    ros::Publisher armPositionsPublisher=n.advertise<brics_actuator::JointPositions>("right_arm_joints",10);
    //ros::Publisher my_pub=n.advertise<std_msgs::Float32MultiArray>("arm_pos",10);
    ros::Publisher my_pub1=n.advertise<geometry_msgs::Twist>("my_trajectory_pos_right",100);
    ros::Rate r(10);
