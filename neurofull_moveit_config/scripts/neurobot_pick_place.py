...
GRIPPER_OPEN = [1.57]
GRIPPER_CLOSED = [0]
GRIPPER_NEUTRAL = [0.85]

GRIPPER_JOINT_NAMES = ['left_joint_gripper_l']
...
class MoveItDemo:
    def __init__(self):
        ...
        # Start the arm in the "left_arm_init" pose stored in the SRDF file
        ...
        target_pose.pose.position.z = 1.02
        ...
        # Return the arm to the "left_arm_init" pose stored in the SRDF file
